...
library_pane_action (GtkAction *action, struct con_win *cwin)
{
	...
	pragha_preferences_set_lateral_panel (cwin->preferences, gtk_toggle_action_get_active(GTK_TOGGLE_ACTION(action)));

	gtk_widget_set_visible (GTK_WIDGET(cwin->browse_mode), pragha_preferences_get_lateral_panel (cwin->preferences));
	...
	gtk_toggle_action_set_active (GTK_TOGGLE_ACTION(paction), pragha_preferences_get_lateral_panel (cwin->preferences));
	...
	gtk_toggle_action_set_active (GTK_TOGGLE_ACTION(maction), pragha_preferences_get_lateral_panel (cwin->preferences));
